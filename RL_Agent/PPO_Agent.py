...
if __name__ == '__main__':
    ...
    env = JavaSnakeEnv(board_size=36)
    ...
    # model.load('C:/root/code_repositories/private_projects/Java_Snake/RL_Agent/logs/snake_a2c/models/a2c_snake_agent_251208_125102.zip')
    # for i in range(3):
    #     visualizeAgentsPlay(model, env)
    #     print('=' * 10)
    # env.close()
